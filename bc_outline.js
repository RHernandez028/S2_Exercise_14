...
function makeOutline() {
      ...
      //source documnet for the outline
...
function createList (source, outlineList) {
      ...
      for (var n = source.firstChild; n !== null; n = n.nextSibling) {
            ...
            if (headLevel !== -1) {
                  //add an id to the heading of it is missing 
                  headNum++;
                  ...
                  //create hypertext links tot he documnet headings
                  ...
                  if (headLevel === prevLevel) {
                        ...
                        //append the new list itemto to a higher list
                        //calculate the differece between the current and previous level
